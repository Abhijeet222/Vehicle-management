...
const About = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#e0e5ec] px-6 py-12">
      <div className="bg-[#e0e5ec] p-10 rounded-[20px] max-w-3xl shadow-[10px_10px_20px_#a3b1c6,_-10px_-10px_20px_#ffffff] text-center transition-all duration-500 hover:scale-[1.01]">
